...
ADD COLUMN     "twoFactorChallengeTokenHash" TEXT,
ADD COLUMN     "twoFactorChallengeExpiresAt" TIMESTAMP(3);

-- CreateIndex
CREATE UNIQUE INDEX "User_twoFactorChallengeTokenHash_key" ON "User"("twoFactorChallengeTokenHash");
